...
public class Car_2_Movement : MonoBehaviour
{

    public float moveSpeed; // Stores the speed variable for the movement speed of the vehicles.
  public GameObject carStart2; // Stores a game object (empty game object for the cars spawn position).
  ...
  void Update()
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            transform.position = carStart2.transform.position; //...Transports the car back to the start position.
    }
    }
}
